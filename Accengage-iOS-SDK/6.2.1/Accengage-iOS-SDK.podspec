Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://dl.bintray.com/accengage/iOS/AccengageKit-6.2.1.zip' }

  s.platform = :ios
  s.ios.deployment_target = '8.0'

  s.frameworks = 'CoreGraphics', 'CoreLocation', 'CoreTelephony', 'iAd', 'SystemConfiguration', 'CFNetwork'
